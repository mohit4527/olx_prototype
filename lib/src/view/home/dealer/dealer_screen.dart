          ...
          child: Column(
            ...
            children: [
                ...
                () => Wrap(
                  ...
                  children: dealerController.dealerTypes.map((type) {
                    return ChoiceChip(
                      label: Text(type),
                      selected:
                          dealerController.selectedDealerType.value == type,
                      onSelected: (_) =>
                          dealerController.selectDealerType(type),
                        ...
                        child: Wrap(
                          children: [
                            ListTile(
                              ...
                              title: Text("Gallery"),
                              onTap: () {
                                dealerController.pickBusinessLogo(
                                  ImageSource.gallery,
                                );
                                Get.back();
                              },
              ...
              Obx(
                () => Row(
                  children: [
                    ...dealerController.businessPhotos.map(
                      (file) => Container(
                    ...
                    GestureDetector(
                      onTap: () => dealerController.pickBusinessPhoto(
                        ImageSource.gallery,
                      ),
                    ...
                    child: GestureDetector(
                      ...
                      child: Obx(
                        () => Container(
                          ...
                          child: Center(
                            child: Text(
                              dealerController.startTime.value?.format(
                                    context,
                                  ) ??
                                  "Select Start Time",
                              style: TextStyle(
                                color: dealerController.startTime.value == null
                                    ? AppColors.appGrey.shade700
                                    : Colors.black,
                              ),
                            ),
                          ),
                    ...
                    child: GestureDetector(
                      ...
                      child: Obx(
                        () => Container(
                          ...
                          child: Center(
                            child: Text(
                              dealerController.endTime.value?.format(context) ??
                                  "Select End Time",
                              style: TextStyle(
                                color: dealerController.endTime.value == null
                                    ? AppColors.appGrey.shade700
                                    : Colors.black,
                              ),
                            ),
              ...
              Obx(
                () => Wrap(
                  ...
                  children: dealerController.paymentMethods.map((method) {
                    return FilterChip(
                      label: Text(method),
                      selected: dealerController.selectedPayments.contains(
                        method,
                      ),
                      ...
                      labelStyle: TextStyle(
                        color:
                            dealerController.selectedPayments.contains(method)
                            ? Colors.white
                            : (isDark ? Colors.white : Colors.black),
                      ),
                    );
