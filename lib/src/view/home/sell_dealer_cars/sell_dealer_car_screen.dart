...
class SellDealerCarScreen extends StatelessWidget {
  ...
  final DealerCarUploadController controller = Get.put(DealerCarUploadController());
  ...
  Future<void> pickImages() async {
    ...
    if (pickedFiles.isNotEmpty) {
      ...
      Get.snackbar("No Image", "No images selected.", snackPosition: SnackPosition.TOP);
    }
  }
